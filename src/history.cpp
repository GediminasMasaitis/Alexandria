...
void updateHHScore(const Position* __restrict__ pos, SearchData* __restrict__ sd, const Move move, int bonus) {
...
void updateRHScore(const Position* __restrict__ pos, SearchData* __restrict__ sd, const Move move, int bonus) {
...
void updateCHScore(SearchStack* __restrict__ ss, const Move move, const int bonus) {
    // Update move score
...
void updateSingleCHScore(SearchStack* __restrict__ ss, const Move move, const int bonus, const int offset) {
    if ((ss - offset)->move) {
...
void updateCapthistScore(const Position* __restrict__ pos, SearchData* __restrict__ sd, const Move move, int bonus) {
...
void UpdateHistories(const Position* __restrict__ pos, SearchData* __restrict__ sd, SearchStack* __restrict__ ss, const int depth, const Move bestMove, const MoveList* __restrict__ quietMoves, const MoveList* __restrict__ noisyMoves, const bool rootNode) {
...
int GetHHScore(const Position* __restrict__ pos, const SearchData* __restrict__ sd, const Move move) {
...
// Returns the history score of a move
int GetCapthistScore(const Position* __restrict__ pos, const SearchData* __restrict__ sd, const Move move) {
    int capturedPiece = isEnpassant(move) ? PAWN : GetPieceType(pos->PieceOn(To(move)));
...
void updateCorrHistScore(const Position * __restrict__ pos, SearchData * __restrict__ sd, const SearchStack* __restrict__ ss, const int depth, const int diff) {
...
int adjustEvalWithCorrHist(const Position * __restrict__ pos, const SearchData * __restrict__ sd, const SearchStack* __restrict__ ss, const int rawEval) {
    int adjustment = 0;
...
int GetHistoryScore(const Position* __restrict__ pos, const SearchData* __restrict__ sd, const Move move, const SearchStack* __restrict__ ss, const bool rootNode) {
    if (!isTactical(move))
